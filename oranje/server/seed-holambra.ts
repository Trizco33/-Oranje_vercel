...
const HOLAMBRA_PLACES: PlaceWithCategorySlug[] = [
...

  {
    ...
    address: "R. Rota dos Imigrantes, 620 - Centro, Holambra - SP, 13825-000", lat: -22.6381, lng: -47.0607,
...

  {
    ...
    address: "Av. das Tulípas, 57 - Centro, Holambra - SP, 13825-000", lat: -22.6380, lng: -47.0615,
    city: "Holambra", state: "SP", country: "Brasil",
    priceRange: "$$$", isFree: false,
    isRecommended: true, isFeatured: true, isPartner: false,
...

  {
    ...
    address: "R. das Dálias, 100 - Jardim Holanda, Holambra - SP, 13827-030", lat: -22.6380, lng: -47.0640,
    city: "Holambra", state: "SP", country: "Brasil",
    phone: "(19) 3802-2090",
...

  {
    ...
    coverImage: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/17/f9/ed/5f/getlstd-property-photo.jpg?w=900&h=500&s=1",
    address: "Rua Bromélias, 206, Holambra - SP, 13825-000", lat: -22.62810, lng: -47.05010,
    city: "Holambra", state: "SP", country: "Brasil",
    priceRange: "$$", isFree: false,
    isRecommended: false, isFeatured: false, isPartner: false,
...

  {
    ...
    coverImage: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2d/30/c2/9f/caption.jpg?w=900&h=500&s=1",
    address: "R. Bromélias, 125 - Centro, Holambra - SP, 13825-055", lat: -22.62817, lng: -47.05019,
    city: "Holambra", state: "SP", country: "Brasil",
    priceRange: "$$", isFree: false,
    openingHours: "Aberto 24h — recepção disponível a qualquer hora",
    isRecommended: false, isFeatured: false, isPartner: false,
    tags: ["hotel", "central", "familia", "casal", "flores", "fim_de_semana"], status: "active",
    dataPending: false,
  },

  {
    ...
    longDesc: "O Hotel Amsterdam Suítes está localizado no Parque Residencial Palm Park, área verde e tranquila de Holambra próxima à Rodovia SP-107. As suítes oferecem mais espaço e privacidade do que o hotel convencional, com ambiente que privilegia o silêncio e o contato com a natureza — ideal para casais que buscam descanso de verdade.",
    coverImage: "https://hotelamsterdamsuites.com.br/wp-content/uploads/2022/05/e261555a-62a9-45b0-99be-fcacda416190.jpg",
    address: "R. Dezesseis, 31 - Parque Res. Palm Park, Holambra - SP, 13825-000", lat: -22.62484, lng: -47.05660,
    city: "Holambra", state: "SP", country: "Brasil",
    priceRange: "$$", isFree: false,
    openingHours: "Aberto 24h — recepção disponível a qualquer hora",
    isRecommended: false, isFeatured: false, isPartner: false,
    tags: ["hotel", "suites", "palm_park", "natureza", "casal", "tranquilo", "fim_de_semana"], status: "active",
    dataPending: false,
  },

  {
    ...
    longDesc: "O Onze Tuin — que significa 'Nosso Jardim' em holandês — é uma das hospedagens mais charmosas de Holambra. Situado no mesmo complexo do Campo do Pouso, no coração da cidade, o local recria a atmosfera de uma vilinha holandesa com atenção aos detalhes: fachadas características, jardins cuidados e uma hospitalidade que faz o hóspede sentir que está numa pequena aldeia europeia. Ótima pedida para quem quer uma experiência diferente das hospedagens convencionais.",
    coverImage: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/30/b2/1e/1e/caption.jpg?w=900&h=500&s=1",
    address: "R. Campo do Pouso, 1050 - Secção A, Holambra - SP, 13825-063", lat: -22.63880, lng: -47.06120,
    city: "Holambra", state: "SP", country: "Brasil",
    priceRange: "$$", isFree: false,
    openingHours: "Aberto 24h — recepção disponível a qualquer hora",
    isRecommended: false, isFeatured: false, isPartner: false,
    tags: ["hospedagem", "holandes", "charmoso", "casal", "romantico", "central", "vilinha", "experiencia"], status: "active",
    dataPending: false,
  },

  {
    ...
    coverImage: "https://cf.bstatic.com/xdata/images/hotel/max1024x768/334575400.jpg?k=89aba352f67194bbbed435d4e97ab0c02ff3b1a24f058e92da80c1a81e84a633&o=",
    address: "R. das Azaléias, 597 - Morada das Flores, Holambra - SP, 13825-000", lat: -22.64039, lng: -47.05359,
    city: "Holambra", state: "SP", country: "Brasil",
    priceRange: "$$", isFree: false,
    openingHours: "Aberto 24h — recepção disponível a qualquer hora",
    isRecommended: false, isFeatured: false, isPartner: false,
    tags: ["pousada", "morada_das_flores", "tranquilo", "aconchegante", "familia", "casal", "fim_de_semana"], status: "active",
    dataPending: false,
  },

  {
    ...
    longDesc: "Os Lofts Holambra ficam no bairro dos Imigrantes, na Rua Flipsen — uma área residencial tranquila que mistura moradores locais e visitantes. Os lofts têm uma proposta mais independente: espaços amplos com cozinha, ideais para quem fica mais de uma noite e quer liberdade para montar a própria rotina na cidade.",
    coverImage: "https://cf.bstatic.com/xdata/images/hotel/max1024x768/573954772.jpg?k=118fd4dfd501ec7f3757a074e0de3d40afc93bf52c03defa8c79570661d1bd79&o=",
    address: "R. Flipsen, 168 - Imigrantes, Holambra - SP, 13825-000", lat: -22.61607, lng: -47.06488,
    city: "Holambra", state: "SP", country: "Brasil",
    priceRange: "$$", isFree: false,
    openingHours: "Aberto 24h — check-in a combinar",
    isRecommended: false, isFeatured: false, isPartner: false,
    tags: ["loft", "imigrantes", "moderno", "casal", "familia", "autonomia", "cozinha", "fim_de_semana"], status: "active",
    dataPending: false,
  },
...

  {
    ...
    address: "Sitio Laguna - Estrada Municipal HBR-155, s/n - Alegre, Holambra - SP, 13825-000", lat: -22.6348, lng: -47.0652,
    city: "Holambra", state: "SP", country: "Brasil",
    priceRange: "$", isFree: false,
    isRecommended: false, isFeatured: false, isPartner: false,
...

  {
    ...
    coverImage: "/places/de-immigrant-garden.png",
...

  {
    ...
    coverImage: "/places/cowburguer.png",
...

  {
    ...
    address: "Petrus Van Ham - Estrada HBR, 266 - Camanducaia, Holambra - SP, 13829-899", lat: -22.6500, lng: -47.0500,
    city: "Holambra", state: "SP", country: "Brasil",
    priceRange: "$$", isFree: false,
    isRecommended: true, isFeatured: true, isPartner: false,
...

  {
    ...
    address: "Alameda Maurício de Nassau - Secção A, Holambra - SP, 13825-000", lat: -22.6392, lng: -47.0612,
    city: "Holambra", state: "SP", country: "Brasil",
    priceRange: "free", isFree: true,
    isRecommended: true, isFeatured: true, isPartner: false,
...

  {
    ...
    address: "R. Campo do Pouso, 1050 - Centro, Holambra - SP, 13825-000", lat: -22.6388, lng: -47.0612,
    city: "Holambra", state: "SP", country: "Brasil",
    priceRange: "$$$", isFree: false,
    isRecommended: true, isFeatured: true, isPartner: false,
...

  {
    ...
    address: "Alameda Maurício de Nassau, 894 - Centro, Holambra - SP, 13825-000", lat: -22.6390, lng: -47.0618,
    city: "Holambra", state: "SP", country: "Brasil",
    priceRange: null, isFree: true,
    isRecommended: true, isFeatured: true, isPartner: false,
...

  {
    ...
    coverImage: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/15/73/6f/ae/don-hamburgo.jpg?w=1200&h=-1&s=1",
    address: "Av. das Tulípas, 44 - Centro, Holambra - SP, 13825-000", lat: -22.6382, lng: -47.0615,
    city: "Holambra", state: "SP", country: "Brasil",
...

  {
    ...
    address: "R. Campo do Pouso, 826 - Secção A, Holambra - SP, 13825-000", lat: -22.6400, lng: -47.0618,
    city: "Holambra", state: "SP", country: "Brasil",
