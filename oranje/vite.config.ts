...
// Only include Manus-specific plugins in development (they inject heavy runtime code
// that conflicts with non-Manus deployments like Vercel).
      ...
      output: {
        manualChunks: {
          ...
          'vendor-radix': [
            ...
            '@radix-ui/react-tooltip', '@radix-ui/react-aspect-ratio',
            '@radix-ui/react-context-menu', '@radix-ui/react-hover-card',
          ],
          'vendor-motion': ['framer-motion'],
          'vendor-charts': ['recharts'],
          'vendor-forms': ['react-hook-form', 'zod', '@hookform/resolvers', 'input-otp'],
          'vendor-misc': ['sonner', 'vaul', 'cmdk', 'date-fns', 'embla-carousel-react', 'class-variance-authority', 'clsx', 'tailwind-merge'],
        },
      },
    },
  },
