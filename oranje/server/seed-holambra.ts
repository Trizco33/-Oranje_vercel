...
const HOLAMBRA_PLACES: PlaceWithCategorySlug[] = [
...

  {
    ...
    _categorySlug: "hoteis",
    shortDesc: "Hotel com ampla área verde, piscina e lazer completo — boa estrutura para famílias",
    longDesc: "O Parque Hotel Holambra tem uma das maiores áreas de lazer entre as hospedagens da cidade. Piscina, espaço verde, ambiente familiar e quartos espaçosos. Boa opção para quem viaja em família ou quer um fim de semana com mais espaço e tranquilidade.",
    address: "Holambra – SP", lat: -22.6380, lng: -47.0640,
    city: "Holambra", state: "SP", country: "Brasil",
    priceRange: "$$", isFree: false,
    isRecommended: true, isFeatured: false, isPartner: false,
    tags: ["hotel", "piscina", "lazer", "familia", "tradicional", "area_verde", "criancas", "fim_de_semana"], status: "active",
    dataPending: true,
  },
